...
const Footer = () => (
  <>
    <div className='bg-black text-white justify-center items-center gap-2 p-5 '> <FaCopyright className='fill-yellow-500 lg:size-5 size-8' />
      <p className='text-lg text-center'>Copyright  2024, Prime Construction, All Rights Reserved </p>
    </div>
